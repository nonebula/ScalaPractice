...
//https://youtu.be/sby4rxdmabI?list=PL8937ckWEfX37TfUEaqXIgilfrUJrcKyW
...
object ObjectOrientation extends App {
  ...
  val basicMath = 1 + 2 //methods apply to types... e.g. this is a method within type 'Int'
  ...
  object Animal { // companions - companion object
    ...
    // things that do not depend on the animal class
  ...
  */
  ...
  //using 'T' as method or value definitions that can be applied later (see below)
  //generic types can be difficult if haven't learned a static-typed language before
